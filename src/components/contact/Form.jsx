    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris gravida urna erat.</p>         
     <form className="contact__form">
        ...
        <label htmlFor="correo">
            <input className="contact__input" type="text" name="lname" placeholder="ejemplo@gmail.com" id="correo" required/>
        </label>
        <label htmlFor="telefono">
            <input className="contact__input" type="tel" name="tel" placeholder="999666333" id="telefono" required/>
        </label>
